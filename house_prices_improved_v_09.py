# house_prices_improved_v_09.py
# Въз основа на v_06 (5 модела + Ridge alpha=0.02)
# Добавен CatBoost като 6-ти базов модел
# Очакван RMSLE: < 0.11974 (лек спад)
...
print("=" * 80)
print("🏠 HOUSE PRICES - МОДЕЛ V_09")
print("   6 базови модела (добавен CatBoost) + Ridge(alpha=0.02) мета-модел")
...
# ============================================================================
# 3. FEATURE ENGINEERING (същите като v_06)
# ============================================================================
...
# Премахване на аутлайъри (както в v_06)
...
# ============================================================================
# 6. ОБУЧЕНИЕ НА БАЗОВИТЕ МОДЕЛИ (6 модела + CatBoost)
# ============================================================================
print("\n📊 Обучение на 6 базови модела с 5-fold CV...")
...
# CatBoost с умерени параметри (като в теста)
cat_params = {
    'iterations': 300,
    'learning_rate': 0.05,
    'depth': 5,
...
# ============================================================================
# 7. МЕТА-МОДЕЛ: Ridge(alpha=0.02) - същият като v_06
# ============================================================================
print("\n🔧 Обучение на мета-модел: Ridge(alpha=0.02)...")
...
submission.to_csv('submission_house_prices_improved_v_09.csv', index=False)

print("\n" + "=" * 80)
print("✅ МОДЕЛ V_09 ЗАВЪРШЕН!")
print("=" * 80)
...
print(f"\n📈 Очакван RMSLE: под 0.11974 (лек спад)")
print(f"📁 Файл: submission_house_prices_improved_v_09.csv")
