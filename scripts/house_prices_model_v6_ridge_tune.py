# house_prices_model_v6_ridge_tune.py
import pandas as pd
import numpy as np
...
print("=" * 80)
print("HOUSE PRICES MODEL V6 - RIDGE ALPHA TUNE (микро подобрение)")
print("=" * 80)
...
# ============================================================
# 2. МОДЕЛИ (същите като в improved)
# ============================================================
...
# ============================================================
# 3. ЕДИНСТВЕНА ПРОМЯНА: alpha от 1.0 на 0.3 (по-малка регуларизация)
# ============================================================
meta_model = Ridge(alpha=0.3, random_state=42)  # в improved беше alpha=1.0
meta_model.fit(meta_train, y)

print("\nКоефициенти на мета модела (Ridge, alpha=0.3):")
...
submission.to_csv('house_prices_model_v6_ridge_alpha_0.3.csv', index=False)

print("\n" + "=" * 80)
print("📊 РЕЗУЛТАТИ")
print("=" * 80)
print(f"   Ridge alpha: 0.3 (преди 1.0)")
...
print("\n🚀 ГОТОВО ЗА КАЧВАНЕ!")
print("📁 Файл: house_prices_model_v6_ridge_alpha_0.3.csv")
print("=" * 80)