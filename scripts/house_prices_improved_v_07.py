...
submission.to_csv('submission_house_prices_improved_v_07.csv', index=False)

print(f"\n✅ Файл: submission_house_prices_improved_v_07.csv")
...
print("📁 Файл: submission_house_prices_improved_v_07.csv")
