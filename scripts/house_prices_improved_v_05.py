...
meta_model = Ridge(alpha=0.05, random_state=42)
...
submission.to_csv('submission_house_prices_improved_v_05.csv', index=False)

print(f"\n✅ Файл: submission_house_prices_improved_v_05.csv")
...
print("📁 Файл: submission_house_prices_improved_v_05.csv")
