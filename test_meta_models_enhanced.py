# test_meta_models_enhanced.py
# Разширен тест на мета-модели с повече базови модели (RF, XGB, LGB, GB, Ridge, CatBoost, ExtraTrees)
# Базиран на най-добрия модел (0.11988)
...
print("=" * 80)
print("🔬 РАЗШИРЕН ТЕСТ НА МЕТА-МОДЕЛИ С ПОВЕЧЕ БАЗОВИ МОДЕЛИ")
print("=" * 80)

# ============================================================================
# 1. ЗАРЕЖДАНЕ НА ДАННИТЕ (същата препроцесинг верига като най-добрия модел)
# ============================================================================
...
# Премахване на аутлайъри (същите като в най-добрия модел)
...
# ============================================================================
# 2. ГЕНЕРИРАНЕ НА OOF ПРОГНОЗИ ОТ 7 БАЗОВИ МОДЕЛА
# ============================================================================
print("\n📊 Генериране на OOF прогнози (5-fold CV)...")
kf = KFold(n_splits=5, shuffle=True, random_state=42)

# Параметри (леко подобрени спрямо v07)
...
# ============================================================================
# 3. ТЕСТВАНЕ НА РАЗЛИЧНИ МЕТА-МОДЕЛИ ВЪРХУ OOF
# ============================================================================
...
print("=" * 80)
print("\n💡 Препоръка: Използвайте този мета-модел във финалния submission.")
