...
submission.to_csv('submission_house_prices_improved.csv', index=False)

print(f"\n✅ Файл: submission_house_prices_improved.csv")
...
print("📁 Файл: submission_house_prices_improved.csv")
